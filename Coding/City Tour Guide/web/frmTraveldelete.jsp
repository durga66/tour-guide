...
<html>
   ...
   <script>
    ...
    <script>
            ...
            $.post("srcTraveldelete.jsp",{opttravelid:travelid},function(res,status){
                alert(res);
            });
            });
            });
    ...
    <body>
        <h1 align="center">Deleting Travels</h1>
        <form name="frmTraveldelete" id="frmTraveldelete">
            ...
            <tr>
                ...
                <tr>
                    <td><input type="button" value="Delete" id="btnDelete">
