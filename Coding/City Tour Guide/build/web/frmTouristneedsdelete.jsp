...
<html>
    ...
    <script>
            ...
            $("#btndelete").click(function(){
             var sno=$("#optsno").val();
            alert("hi:");
            $.post("srcTouristneedsdelete.jsp",{optsno:sno},function(res,status){
                alert(res);
            });
            });
            });
    ...
    <body>
        <h1 align="center">Deleting Touristneeds</h1>
        <form name="frmTouristneedsdelete.jsp" id="frmTouristneeds">
            <table align="center" border="1">
                <tr>
                    <td>Serrial Number:</td>
